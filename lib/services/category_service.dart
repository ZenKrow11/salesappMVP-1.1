...
final List<MainCategory> allCategories = [
  ...
  MainCategory(firestoreName: 'Milchprodukte und Eier', style: const CategoryStyle(displayName: 'Milchprodukte & Eier', color: Color(0xFFF1C40F), icon: Icons.egg,), subcategories: const [SubCategory(name: 'Butter und Eier'), SubCategory(name: 'Käse'), SubCategory(name: 'Milch und Molkereiprodukte'),],),
  ...
  MainCategory(firestoreName: 'Spezifische Ernährung', style: const CategoryStyle(displayName: 'Spezifische Ernährung', color: Color(0xFF7F8C8D), icon: Icons.restaurant_menu,), subcategories: const [SubCategory(name: 'Vegane Produkte'), SubCategory(name: 'Convenience und Fertiggerichte'),],),
