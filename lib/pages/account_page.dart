...
class AccountPage extends ConsumerWidget {
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to logout?', style: TextStyle(color: theme.inactive)),
          actions: <Widget>[
            TextButton(
  ...
  void _showDeleteAccountDialog(BuildContext context, WidgetRef ref) {
    ...
    showDialog(
      ...
      builder: (dialogContext) {
        // Use a Consumer here to rebuild the dialog on loading state changes
        return Consumer(builder: (context, ref, child) {
          ...
          return AlertDialog(
            ...
            content: Column(mainAxisSize: MainAxisSize.min, children: [
              Text( 'This action is permanent and cannot be undone. All your lists and data will be lost. Please enter your password to confirm.', style: TextStyle(color: theme.inactive)),
  ...
  Widget _buildUserInfoHeader({required AppThemeData theme, required User? user, String? displayName}) {
    return Padding(
  ...
  Widget _buildSubListItem(String title, BuildContext context, {required AppThemeData theme, required VoidCallback onTap, bool isDestructive = false}) {
    ...
    final defaultOnTap = () => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('$title is not yet implemented.')));
    return ListTile(
